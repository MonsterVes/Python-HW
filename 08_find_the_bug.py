...
def find_similar(list_of_numbers):
    similar_lists = []
    """ 1. Row 29 - Not starting from index 0, so the first number is not being compared.
        2. Row 29 - compares each number, so if there are more than two consecutive equal numbers it will create several sublists
    """
